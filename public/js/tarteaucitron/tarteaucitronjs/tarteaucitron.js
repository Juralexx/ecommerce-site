...
var tarteaucitron = {
    ...
    "load": function () {
        ...
        var cdn = tarteaucitron.cdn,
            ...
            pathToLang = cdn + '././js/tarteaucitron/tarteaucitronjs/lang/tarteaucitron.' + language + (useJSDelivrMinifiedJS ? '.min' : '') + '.js?v=' + tarteaucitron.version,
            pathToServices = cdn + '././js/tarteaucitron/tarteaucitronjs/tarteaucitron.services' + (useJSDelivrMinifiedJS ? '.min' : '') + '.js?v=' + tarteaucitron.version,
        ...
        if ( !tarteaucitron.parameters.useExternalCss ) {
            ...
            linkElement.href = cdn + '././js/tarteaucitron/tarteaucitronjs/css/tarteaucitron' + (useJSDelivrMinifiedJS ? '.min' : '') + '.css?v=' + tarteaucitron.version;
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.orientation === 'middle') {
                    var customThemeMiddle = document.createElement('style'),
                        cssRuleMiddle = 'div#tarteaucitronRoot.tarteaucitronBeforeVisible:before {content: \'\';position: fixed;width: 100%;height: 100%;background: white;top: 0;left: 0;z-index: 999;opacity: 0.5;}div#tarteaucitronAlertBig:before {content: \'' + tarteaucitron.lang.middleBarHead + '\';}body #tarteaucitronRoot div#tarteaucitronAlertBig {min-width: 285px;height: auto;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {display: block;}@media screen and (max-width: 900px) {div#tarteaucitronAlertBig button {margin: 0 auto 10px!important;display: block!important;}}';
